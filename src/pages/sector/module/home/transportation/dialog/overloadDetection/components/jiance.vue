  ...
  <div class="jiance-bg">
    <div class="base-top">
      ...
      <div class="top-item">
        ...
        <div class="top-name">超限数量</div>
      </div>
      <div class="top-line"></div>
      <div class="top-item">
        <div class="top-icon3"></div>
        <div class="top-count">22辆</div>
        <div class="top-name">卸载重量</div>
      </div>
      <div class="top-line"></div>
      <div class="top-item">
        <div class="top-icon4"></div>
        <div class="top-count">24辆</div>
        <div class="top-name">百吨王数</div>
      </div>
    </div>
    ...
    <ItemTitle style="margin-left: 40px;margin-top: 40px;" title="超限车辆时间分布规律" />
