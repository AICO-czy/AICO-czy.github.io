    ...
    <div class="column fit">
      <div class="col-auto">
        <div class="row items-center title-content">
          ...
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/服务区图标.svg" class="info-icon"></q-icon>
          </div>
          <div class="col">
      ...
      <div class="col">
        <div class="info-content" v-if="state.selectBtn==='basicInfo'">
          <div class="info-item" v-for="(info,index) in state.dataInfo" :key="index">
            <div class="row items-center info-item-content">
              ...
              <div class="col">
                <template v-if="info.name==='配套设施情况'">
                  <div class="row items-center">
                    <div class="col-auto" v-for="(icon,index) in info.icons" :key="index">
                      <q-icon :name="icon.url" class="facility-icon"></q-icon>
                    </div>
                  </div>
                </template>
                <div class="info-item-value" v-else>{{ info.value }}</div>
              </div>
            </div>
          </div>
        </div>
        <div class="video-content" v-else>
          <div class="column fit">
            ...
            <div class="col">
              <div class="video-img">
                <q-img src="icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/服务区视频封面.png" class="fit"></q-img>
              </div>
            </div>
          </div>
        </div>
...
<script setup lang="ts" name="service-areaInfo">
  ...
  dataInfo: [
    ...
    },
    {
      ...
      icons: [
        {
          label: "停车场",
          url: "img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/停车场.svg",
        },
        {
          label: "加油站",
          url: "img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/加油站.svg",
        },
        {
          label: "餐厅",
          url: "img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/餐厅.svg",
        },
        {
          label: "住宿",
          url: "img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/床.svg",
        },
      ],
    },
  ],
