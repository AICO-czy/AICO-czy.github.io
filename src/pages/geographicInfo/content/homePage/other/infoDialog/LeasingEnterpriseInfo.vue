<!--道(水)路运输-租赁企业信息弹窗-->
<template>
  <div class="leasing-enterprise-info">
    <div class="column fit">
      <div class="col-auto">
        <div class="row items-center title-content">
          ...
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/roadTransport/infoDialog/租赁企业.svg" class="info-icon"></q-icon>
          </div>
          <div class="col">
...
<script setup lang="ts" name="leasing-enterpriseInfo">
