    ...
    <div class="column fit">
      <div class="col-auto">
        <div class="row items-center title-content">
          ...
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/收费站图标.svg" class="info-icon"></q-icon>
          </div>
          <div class="col">
      ...
      <div class="col">
        ...
        <div class="video-content" v-if="state.selectBtn==='videoSurveillance'">
          <div class="column fit">
            ...
            <div class="col">
              <div class="video-img">
                <q-img src="icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/收费站视频封面.png" class="fit"></q-img>
              </div>
            </div>
          </div>
        </div>
...
<script setup lang="ts" name="toll-stationInfo">
