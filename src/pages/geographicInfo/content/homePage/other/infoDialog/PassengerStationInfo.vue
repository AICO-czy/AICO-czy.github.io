<!--道(水)路运输-客运站信息弹窗-->
<template>
  <div class="passenger-station-info">
    <div class="column fit">
      <div class="col-auto">
        <div class="row items-center title-content">
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/roadTransport/infoDialog/头部左侧.svg" class="title-icon"></q-icon>
          </div>
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/roadTransport/infoDialog/客运站.svg" class="info-icon"></q-icon>
          </div>
          <div class="col">
      ...
      <div class="col">
        ...
        <div class="info-content" v-if="state.selectBtn==='operatingInformation'">
        ...
        <div class="video-content" v-if="state.selectBtn==='videoSurveillance'">
          <div class="column fit">
            ...
            <div class="col">
              <div class="video-img">
                <q-img src="icons/cdsgl/monitoringAndEarlyWarning/roadTransport/infoDialog/客运站视频封面.png" class="fit"></q-img>
              </div>
            </div>
          </div>
        </div>
...
<script setup lang="ts" name="passenger-stationInfo">
