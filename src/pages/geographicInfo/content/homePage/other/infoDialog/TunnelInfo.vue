    ...
    <div class="column fit">
      <div class="col-auto">
        <div class="row items-center title-content">
          ...
          <div class="col-auto">
            <q-icon name="img:icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/隧道图标.svg" class="info-icon"></q-icon>
          </div>
          <div class="col">
      ...
      <div class="col">
        ...
        <div class="video-content" v-else>
          <div class="column fit">
            ...
            <div class="col">
              <div class="video-img">
                <q-img src="icons/cdsgl/monitoringAndEarlyWarning/highwayOperation/infoDialog/隧道视频封面.png" class="fit"></q-img>
              </div>
            </div>
          </div>
        </div>
...
<script setup lang="ts" name="tunnelInfo">
