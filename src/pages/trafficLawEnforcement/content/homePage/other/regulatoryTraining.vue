          ...
          <div class="column fit">
            <div class="col-auto">
              <div class="row items-center title-content">
                ...
                <div class="col">学法内容</div>
                <div class="col">学法时间</div>
                <div class="col">单位名称</div>
                <div class="col">参与人数</div>
...
const state = reactive({
  ...
  basicManagementData: [
    ...
    {
      index: 6,
      studyLawTheme: "公司安全生产管理《巡游出租汽车经营服务管理规定》制度",
      studyLawTime: "2025年8月8日",
      studyLeader: "承德县交通运输局",
      participants: "赵果某、钱某某、孙某某、李某某",
      remarks: "无"
