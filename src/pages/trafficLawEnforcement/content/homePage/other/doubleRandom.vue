          ...
          <div class="column fit">
            <div class="col-auto">
              <div class="row items-center title-content">
                ...
                <div class="col">抽查计划编号</div>
                <div class="col">抽查计划名称</div>
                <div class="col">抽查任务编号</div>
                <div class="col">抽查任务名称</div>
                <div class="col">抽查类型</div>
                <div class="col">抽查比列</div>
                <div class="col">抽查事项</div>
              </div>
            </div>
            <div class="col">
              <q-scroll-area class="fit" ref="agencyListScrollArea" :thumb-style="state.thumbStyle"
                ...
                <q-list dark separator dense class="q-ml-none" ref="agencyList">
                  <q-item class="agencyList-row" v-for="(item) in state.inspectionTaskData" :key="item.index" clickable
                    v-ripple :data-id="item.id">
                    <div class="row items-center agencyList-item">
                      <div class="col-1 agencyList-item-style">{{ item.index }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionPlanNo }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionPlanName }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionTaskNo }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionTaskName }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionType }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionRatio }}</div>
                      <div class="col agencyList-item-style">{{ item.inspectionMatters }}</div>
                    </div>
                  </q-item>
                </q-list>
                ...
                <div v-if="state.inspectionTaskData.length === 0 && !state.loading" class="text-center nodata-label">
                  暂无数据！
                </div>
              </q-scroll-area>
            </div>
...
const state = reactive({
  ...
  inspectionTaskData: [
    {
      index: 1,
      inspectionPlanNo: "2025001",
      inspectionPlanName: "2025年承德市交通运输局部门联合随机抽查001",
      inspectionTaskNo: "001号",
      inspectionTaskName: "承德市交通运输局2025年开展双桥区、高新区普通货运检查",
      inspectionType: "定向",
      inspectionRatio: "结合企业信用风险分类分级确定",
      inspectionMatters: "对市场主体的监督检查，对经营者监督检查，交通运输领域安全生产经营"
    },
    {
      index: 2,
      inspectionPlanNo: "2025002",
      inspectionPlanName: "2025年承德市交通运输局部门联合随机抽查001",
      inspectionTaskNo: "002号",
      inspectionTaskName: "承德市交通运输局2025年开展双桥区、高新区普通货运检查",
      inspectionType: "定向",
      inspectionRatio: "结合企业信用风险分类分级确定",
      inspectionMatters: "对市场主体的监督检查，对经营者监督检查，交通运输领域安全生产经营"
    ...
    {
      index: 3,
      inspectionPlanNo: "2025003",
      inspectionPlanName: "2025年承德市交通运输局部门联合随机抽查001",
      inspectionTaskNo: "003号",
      inspectionTaskName: "承德市交通运输局2025年开展双桥区、高新区普通货运检查",
      inspectionType: "定向",
      inspectionRatio: "结合企业信用风险分类分级确定",
      inspectionMatters: "对市场主体的监督检查，对经营者监督检查，交通运输领域安全生产经营"
    ...
    {
      index: 4,
      inspectionPlanNo: "2025004",
      inspectionPlanName: "2025年承德市交通运输局部门联合随机抽查001",
      inspectionTaskNo: "004号",
      inspectionTaskName: "承德市交通运输局2025年开展双桥区、高新区普通货运检查",
      inspectionType: "定向",
      inspectionRatio: "结合企业信用风险分类分级确定",
      inspectionMatters: "对市场主体的监督检查，对经营者监督检查，交通运输领域安全生产经营"
    ...
    {
      index: 5,
      inspectionPlanNo: "2025005",
      inspectionPlanName: "2025年承德市交通运输局部门联合随机抽查001",
      inspectionTaskNo: "005号",
      inspectionTaskName: "承德市交通运输局2025年开展双桥区、高新区普通货运检查",
      inspectionType: "定向",
      inspectionRatio: "结合企业信用风险分类分级确定",
      inspectionMatters: "对市场主体的监督检查，对经营者监督检查，交通运输领域安全生产经营"
