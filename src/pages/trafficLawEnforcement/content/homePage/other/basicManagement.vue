...
<template>
  <div class="basic-management-dialog">
    <div class="content-title">基础管理制度规范化</div>
          ...
          <div class="column fit">
            <div class="col-auto">
              <div class="row items-center title-content">
                ...
                <div class="col">具体制度名称</div>
                <div class="col">制度分类</div>
                <div class="col">责任部门/岗位</div>
                <div class="col">实施目标</div>
                <div class="col">主要内容概述</div>
              </div>
            </div>
            <div class="col">
                ...
                <q-list dark separator dense class="q-ml-none" ref="agencyList">
                  <q-item class="agencyList-row" v-for="(item) in state.basicManagementData" :key="item.index" clickable
                    ...
                    <div class="row items-center agencyList-item">
                      ...
                      <div class="col agencyList-item-style">{{ item.specificSystemName }}</div>
                      <div class="col agencyList-item-style">{{ item.systemCategory }}</div>
                      <div class="col agencyList-item-style">{{ item.responsibleDeptPost }}</div>
                      <div class="col agencyList-item-style">{{ item.implementationGoal }}</div>
                      <div class="col agencyList-item-style">{{ item.mainContentOverview }}</div>
                    </div>
                  </q-item>
                </q-list>
...
const state = reactive({
  ...
  basicManagementData: [
    {
      index: 1,
      specificSystemName: "公司安全生产管理制度",
      systemCategory: "执法人员管理制度",
      responsibleDeptPost: "人事部门/执法大队负责人",
      implementationGoal: "确保执法队伍人员素质符合岗位要求，从源头保障执法专业性和合法性",
      mainContentOverview: "队伍的基本条件，如学历要求、专业背景、年龄限制，需通过执法资格考"
    },
    {
      index: 2,
      specificSystemName: "公司安全生产管理制度",
      systemCategory: "执法人员管理制度",
      responsibleDeptPost: "法制部门/各执法大队",
      implementationGoal: "确保执法队伍人员素质符合岗位要求，从源头保障执法专业性和合法性",
      mainContentOverview: "队伍的基本条件，如学历要求、专业背景、年龄限制，需通过执法资格考"
    },
    {
      ...
      specificSystemName: "公司安全生产管理制度",
      systemCategory: "执法人员管理制度",
      responsibleDeptPost: "考核部门/纪检监察部门",
      implementationGoal: "确保执法队伍人员素质符合岗位要求，从源头保障执法专业性和合法性",
      mainContentOverview: "队伍的基本条件，如学历要求、专业背景、年龄限制，需通过执法资格考"
    },
    {
    ...
    {
      index: 6,
      specificSystemName: "执法用语规范",
      systemCategory: "执法人员管理制度",
      responsibleDeptPost: "各执法大队负责人/法制部门",
      implementationGoal: "确保执法队伍人员素质符合岗位要求，从源头保障执法专业性和合法性",
      mainContentOverview: "队伍的基本条件，如学历要求、专业背景、年龄限制，需通过执法资格考"
    }
  ] as any,
