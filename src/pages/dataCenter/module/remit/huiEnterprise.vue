  ...
  <div class="remittance-department">
    <div class="remittance-department-content">
      ...
      <div class="content-hui">
        ...
        <div class="content-hui-enterprise column justify-center items-center">
          <img class="content-hui-enterprise-img" :src="png1" alt="">
      ...
      <div class="access-animation">
        <div id="intro-gd1" class="fit"></div>
      </div>
...
import png1 from "src/assets/image/dataCenter/切图 24.png";
...
onMounted(() => {
  lottie.loadAnimation({
    container: document.getElementById("intro-gd1"), // DOM元素
