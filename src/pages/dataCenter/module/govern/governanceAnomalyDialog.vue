<template>
  <div class="access-dialog">
    <div class="access-dialog-content">
      ...
      <div class="access-dialog-box column justify-center items-center">
        <div class="access-dialog-box-title">
          <span>数据治理异常报警</span>
        </div>
        <div class="access-dialog-box-table col column justify-between">
          <q-table class="content-tab-table-content" flat dark :rows="state.tableData" :columns="state.columns"
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="governanceDataName" :props="props">
                  {{ props.row.governanceDataName }}
                </q-td>
                <q-td key="dataNum" :props="props">
                  {{ props.row.dataNum }}
                </q-td>
              </q-tr>
            </template>
...
const state = reactive({
  ...
  columns: [
    ...
    {
      name: 'governanceDataName',
      required: true,
      label: '治理数据名称',
      align: 'center',
      field: row => row.governanceDataName,
    },
    {
      name: 'dataNum',
      required: true,
