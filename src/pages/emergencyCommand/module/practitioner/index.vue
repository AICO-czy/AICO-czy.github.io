  ...
  <div class="bg">
    ...
    <div class="body-box">
      <el-table :data="tableData" style="width: 100%;height: 100%;" stripe>
        <el-table-column prop="cphm" label="驾驶员姓名" width="400" />
        <el-table-column prop="yh" label="业户名称" />
        <el-table-column prop="cj" label="驾驶员类别" />
        <el-table-column prop="cp" label="性别" />
        <el-table-column prop="zd" label="出生日期" />
        <el-table-column prop="zh" label="资格证号" />
        <el-table-column prop="yxq" label="资格证有效期" />
        <el-table-column prop="cl" label="电话" width="350" />
