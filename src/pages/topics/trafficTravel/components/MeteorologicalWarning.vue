...
<template>
  <q-dialog v-model="alert" seamless>
    <div class="bg">
      <dialog-title title="气象预警信息" @close="handleClose" />
...
const tableHeader = ref([
  ...
  { name: '影响区域', value: 'wz', width: "200px" },
  { name: '预警类型', value: 'type', type: 'lx', width: "200px" },
...
const tableData = ref([
  {
    ...
    wz: '兴隆、承德县、滦平潇洒打赏',
    type: '道路拥堵',
    content: '承德市气象台2025年sadasds',
    ai: '【暴雨预警】预计未来将出现dasdada',
    send: '已发布'
  },
  {
    sendTime: '2022-09-06 12:41:10',
