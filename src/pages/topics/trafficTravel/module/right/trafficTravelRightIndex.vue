<template>
  <div class="trafficTravelRightIndex">
    ...
    <div class="fit column">
      <div class="right-top">
        <div class="right-top-title">国家一号风景大道</div>
        <q-btn
          class="close-btn"
          round
      ...
      <div class="right-bottom col column">
        <div class="right-bottom-content-top row justify-between">
          <div
            class="right-bottom-content-top-item"
            v-for="item in state.topData"
            :key="item.value"
          >
            ...
            <div class="bottom-content row justify-center items-center">
              <div class="bottom-content-value">
                {{ item.value }}
        ...
        <div class="right-bottom-content-bottom column col">
          <div class="right-bottom-content-bottom-heard">
            <q-icon
              name="img:icons/trafficTravel/bottom-title.png"
              size="160px"
              class="heard-icon"
            ></q-icon>
            <span>品质提升工程</span>
            <div class="heard-select">
              <el-select
                v-model="state.selectFirm"
                :teleported="false"
                class="firm-Select"
              >
                <el-option
                  v-for="item in state.firmOptions"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <div class="right-bottom-content-bottom-item-info column">
            <div class="col row items-center">
              <div class="col info-interval row items-center">
                <q-icon
                  name="img:icons/trafficTravel/lkts.png"
                  class="info-icon"
                ></q-icon>
              ...
              <div class="col row items-center">
                <q-icon
                  name="img:icons/trafficTravel/lhts.png"
                  class="info-icon"
                ></q-icon>
            ...
            <div class="col row items-center info-color">
              <div class="col info-interval row items-center">
                <q-icon
                  name="img:icons/trafficTravel/afts.png"
                  class="info-icon"
                ></q-icon>
              ...
              <div class="col row items-center">
                <q-icon
                  name="img:icons/trafficTravel/fwssts.png"
                  class="info-icon"
                ></q-icon>
          ...
          <div class="right-bottom-content-bottom-item-years-echarts column">
            <div class="echarts-title row items-center justify-center">
              历年投资情况
            </div>
...
.right-top {
  width: 100%;
  height: 102px;
  background-image: url("assets/component/trafficTravel/topTitle.png");
...
.right-top-close {
  width: 80px;
  height: 80px;
  background-image: url("assets/component/trafficTravel/delete.png");
  background-size: 100% 100%;
  position: absolute;
  top: 20px;
  right: 20px;
...
.right-bottom {
  width: 100%;
  background-image: url("assets/component/trafficTravel/rightDialogBg.png");
  background-size: 100% 100%;
}
...
.right-bottom-content-top-item {
  width: 266px;
  height: 136px;
  background-image: url("assets/component/trafficTravel/topRight-item.png");
  background-size: 100% 100%;
  margin-bottom: 40px;
}
...
.bottom-top-title-left-icon {
  width: 18px;
  height: 15px;
  background-image: url("assets/component/trafficTravel/smalljiantou.png");
  background-size: 100% 100%;
}
...
.right-bottom-content-bottom {
  ...
  background-image: url("assets/component/trafficTravel/bottomContentBg.png");
  background-size: 100% 100%;
  position: relative;
}
...
.right-bottom-content-bottom-heard {
  width: 70%;
  height: 82px;
  background-image: url("assets/component/trafficTravel/bottomTitleBg.png");
  background-size: 100% 100%;
  position: absolute;
  top: -30px;
  left: 50px;
...
.right-bottom-content-bottom-item-years-echarts {
  ...
  height: 34%;
  margin-top: 40px;
  background-image: url("assets/component/trafficTravel/echartsBg.png");
  background-size: 100% 100%;
}
