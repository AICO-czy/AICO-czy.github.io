<template>
  <dialog-com v-model="show1" :tip="showtype" :positions="['2100px', '360px']" title="进京访基本情况列表" size="lange"
    ...
    <div class="con" v-else="showtype[0] == 'chart'">
      ...
      <div class="table">
        <el-table :data="tableData" stripe height="1250px" style="width: 2080px;">
          <el-table-column label="序号" prop="index" width="150" align="center" />
          <el-table-column label="时间" prop="time" align="center" width="250" />
          <el-table-column label="诉求" prop="number" width="250" />
          <el-table-column label="信访人" prop="type2" align="center" width="250" />
          <el-table-column label="途径" prop="type2" align="center" width="250" />
          <el-table-column label="人数" prop="type2" align="center" width="250" />
          <el-table-column label="分类" prop="type2" align="center" width="250" />
          <el-table-column label="责任单位" prop="type2" width="250" />
          <el-table-column label="接待人员" prop="type2" align="center" width="250" />
          <el-table-column label="累计接待人员" prop="type2" align="center" width="250" />
          <el-table-column label="领导接访约访" prop="type2" align="center" width="250" />
          <el-table-column label="累计领导接访人数" prop="type2" align="center" width="250" />
          <el-table-column label="案件状态" prop="type2" align="center" width="250" />
          <el-table-column label="是否进京访" prop="type2" align="center" width="250" />
          <el-table-column label="是否交办件" prop="type2" align="center" width="250" />
          <el-table-column label="交办状态" prop="type2" align="center" width="250" />
          <el-table-column label="是否督办件" prop="type2" align="center" width="250" />
          <el-table-column label="督办状态" prop="type2" align="center" width="250" />
          <el-table-column label="是否属于“四应四不”情况" prop="type2" align="center" width="250" />
          <el-table-column label="重复件状态" prop="type2" align="center" width="250" />
          <el-table-column label="处理情况概要" prop="type2" width="250" />
...
watch(() => dialogVisible.value,()=>{
  show1.value = dialogVisible.value == '进京访基本情况'
