<template>
  <dialog-com v-model="show1" :tip="showtype" :positions="['2100px', '360px']" title="进京访责任单位情况" size="lange"
    ...
    <div class="con" v-else-if="showtype[0] == 'detile'">
      <div class="search">
        <el-form inline :model="formInline" class="form-inline">
          <el-form-item label="">
            <el-input v-model="formInline.user" :prefix-icon="Search" placeholder="请输入..." clearable />
...
watch(() => dialogVisible.value, () => {
  show1.value = dialogVisible.value == '进京访责任单位'
  ...
  xAxis: [
    {
      type: 'category',
      data: [
        '执法支队', '公路养护事业发展中心', '公路建设事业发展中心', '地方道路事业发展中心'
      ],
      axisTick: {
        alignWithLabel: true
      },
