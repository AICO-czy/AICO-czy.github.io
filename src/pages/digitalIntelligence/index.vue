<template>
  <div class="digital-intelligence-index">
    <div class="travel-index">
      <div class="content-title">交通数智中心</div>
...
.digital-intelligence-index {
  ...
  height: 100%;
  position: relative;
  background-image: url("assets/image/digitalIntelligence/bglittleimg.png");
...
.travel-index {
  ...
  background-image: url("assets/image/digitalIntelligence/borderLine.png");
  background-size: 102.5% 109.5%;
  background-position: center;
